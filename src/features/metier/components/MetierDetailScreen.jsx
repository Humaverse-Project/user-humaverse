            ...
            <Grid container spacing={2} color={"black.main"}>
                ...
                >
                    ...
                    <Accordion>
                        ...
                        >
                            <Typography variant='h4' sx={{ mt:1 }}>Emplois</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Grid sx={{ flexGrow: 1,mt:1, ml:2 }} container spacing={2}>
                            {emplois.map((emploi) => (
                                <Grid item xs={6} key={emploi.id}>
                                    <ListItem sx={{p:0}}>• {emploi.emploiTitre}</ListItem>
                                </Grid>
                            ))}
                        </Grid>
                        </AccordionDetails>
                    ...
                    <Accordion>
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon />}
                        >
                            <Typography variant='h4' sx={{ mt:1 }}>Définition</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Grid sx={{ flexGrow: 1,mt:1, ml:2 }} container spacing={2}>
                    ...
                    <Accordion>
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon />}
                        >
                            <Typography variant='h4' sx={{ mt:1 }}>Accès au métier</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Grid sx={{ flexGrow: 1,mt:1, ml:2 }} container spacing={2}>
                    ...
                    <Accordion>
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon />}
                        >
                            <Typography variant='h4' sx={{ mt:1 }}>Compétences</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                                ...
                                <><Typography variant='h5' sx={{ mt:2,ml:2 }}>Savoir-faire</Typography><hr></hr>
                                        {Object.keys(competance["SAVOIRS FAIRE"]).map((accessitem) => (
                                            <><></><Grid sx={{ flexGrow: 1, mt: 1, ml: 2 }} container spacing={2}>
                                                ...
                                                </Grid><Grid item xs={6} key={accessitem + "2"}>
                    ...
                    <Accordion>
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon />}
                        >
                            <Typography variant='h4' sx={{ mt:1 }}>Contextes de travail</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Grid sx={{ flexGrow: 1,mt:1, ml:2 }} container spacing={2}>
                                { "CONDITIONS_TRAVAIL" in context ? (
                                    <>
                                        <Grid sx={{ flexGrow: 1, mt: 1, ml: 2 }} container spacing={2}>
                                            <Grid item xs={5} key={"Conditions de travail et risques professionnels"}>
                                                <ListItem sx={{ p: 0 }}> Conditions de travail et risques professionnels</ListItem>
                                            </Grid><Grid item xs={6}>
                                                {context["CONDITIONS_TRAVAIL"].map((accessitem) => (
                                                    <ListItem sx={{ p: 0 }}> {accessitem.brqCtxTitre}</ListItem>
                                                ))}
                                            </Grid>
                                        </Grid><hr></hr>
                                    </>
                                ...
                                { "HORAIRE_ET_DUREE_TRAVAIL" in context ? (
                                    <>
                                        <Grid sx={{ flexGrow: 1, mt: 1, ml: 2 }} container spacing={2}>
                                            <Grid item xs={5} key={"Horaires et durée du travail"}>
                                                <ListItem sx={{ p: 0 }}> Horaires et durée du travail</ListItem>
                                            </Grid><Grid item xs={6}>
                                                {context["HORAIRE_ET_DUREE_TRAVAIL"].map((accessitem) => (
                                                    <ListItem sx={{ p: 0 }}> {accessitem.brqCtxTitre}</ListItem>
                                                ))}
                                            </Grid>
                                        </Grid><hr></hr>
                                    ...
                                    <>
                                        <Grid sx={{ flexGrow: 1, mt: 1, ml: 2 }} container spacing={2}>
                                            <Grid item xs={5} key={"Publics spécifiques"}>
                                                <ListItem sx={{ p: 0 }}> Publics spécifiques</ListItem>
                                            </Grid><Grid item xs={6}>
                                    ...
                                    <>
                                        <Grid sx={{ flexGrow: 1, mt: 1, ml: 2 }} container spacing={2}>
                                            <Grid item xs={5} key={"Types de structures"}>
                                                <ListItem sx={{ p: 0 }}> Types de structures</ListItem>
                                            </Grid><Grid item xs={6}>
                                                {context["TYPE_STRUCTURE_ACCUEIL"].map((accessitem) => (
                                                    <ListItem sx={{ p: 0 }}> {accessitem.brqCtxTitre}</ListItem>
                                                ))}
                                            </Grid>
                                        </Grid><hr></hr>
                                    ...
                                    <>
                                        <Grid sx={{ flexGrow: 1, mt: 1, ml: 2 }} container spacing={2}>
                                            <Grid item xs={5} key={"LIEU_ET_DEPLACEMENT"}>
                                                <ListItem sx={{ p: 0 }}> LIEU_ET_DEPLACEMENT</ListItem>
                                            </Grid><Grid item xs={6}>
                                                {context["LIEU_ET_DEPLACEMENT"].map((accessitem) => (
                                                    <ListItem sx={{ p: 0 }}> {accessitem.brqCtxTitre}</ListItem>
                                                ))}
                                            </Grid>
                                        </Grid><hr></hr>
                    ...
                    <Accordion>
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon />}
                        >
                            <Typography variant='h4' sx={{ mt:1 }}>Mobilité professionnelle</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
