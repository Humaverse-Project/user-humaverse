...
function CompetanceDetailScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setdefinition(
          reponsemetie.appelation.romeData.rome_definition.split("\\n")
        );
        setaccess(
          reponsemetie.appelation.romeData.rome_acces_metier.split("\\n")
        );
        setmobilite({
          romeevolution: reponsemetie.appelation.romeData.romeevolution,
          romeproche: reponsemetie.appelation.romeData.romeproche,
        });
  ...
  if (loading || error) {
    return (
      <Fragment>
        <HeaderInScreen title={"Fiche Compétences - " + code} />
  ...
  return (
    <Fragment>
      <HeaderInScreen title={"Fiche Compétences - " + titre} />
      <Box
                ...
                <AccordionDetails>
                  <Grid sx={{ flexGrow: 1, ml: 2 }} container spacing={2}>
                    <Grid item xs={6} key={emploi.id}>
                      <ListItem>
                        • <b>Titre</b>: {emploi.emploiTitre}
                      </ListItem>
                      <ListItem>
                        • <b>Date création</b>:{" "}
                        {datefonctionun(emploi.createdAt)}
                      </ListItem>
                      <ListItem>
                        • <b>Derniere mise à jours</b>:{" "}
                        {datefonctionun(emploi.updatedAt)}
                      </ListItem>
                    </Grid>
                  </Grid>
                </AccordionDetails>
                ...
                <AccordionDetails>
                  ...
                  >
                    <Grid item xs={11} key={emploi.romeData.id}>
                      <ListItem>
                        • <b>Code ROME</b>: {emploi.romeData.rome_coderome}
                      </ListItem>
                      <ListItem>
                        • <b>Libellé</b>: {emploi.romeData.nom}
                      </ListItem>
                    </Grid>
                    ...
                    <>
                      ...
                      >
                        ...
                        <Grid item xs={4} key={definitionitem.accreTitre + "5"}>
                          <ListItem sx={{ p: 0 }}>
                            {" "}
                            {datefonctionun(definitionitem.createdAt)}
                          </ListItem>
                        </Grid>
                      </Grid>
                    </>
